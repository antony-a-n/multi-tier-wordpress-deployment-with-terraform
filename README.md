...
values to variables such as "project" , "environment" , "CIDR block" etc. The code for VPC module is stored in a github repository "aws-vpc-module" in htis same account. You can view the source code of VPC module  [here](https://github.com/antony-a-n/aws-vpc-module/).
